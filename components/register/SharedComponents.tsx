  ...
  return (
    <div>
      ...
      <input
        ...
        maxLength={maxLength}
        readOnly={readOnly}
        className={`w-full px-3.5 py-3 rounded-xl sm:rounded-2xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2014FF] focus:border-transparent transition-all font-medium min-h-[44px] ${
          readOnly
  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={onChange}
        accept={accept}
        className="w-full px-3.5 py-3 rounded-xl sm:rounded-2xl border border-slate-200 bg-slate-50/50 text-sm focus:outline-none focus:ring-2 focus:ring-[#2014FF] focus:border-transparent transition-all font-medium text-slate-900 min-h-[44px]"
      />
      {helperText && (
